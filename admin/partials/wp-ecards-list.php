...
<div class="wrap">
    ...
    <div id="message" class="updated">
        <p>
            If you need help please <a href="mailto:tim@ecardwidget.com">email me</a>. Also, I'd really appreciate a <a href="https://wordpress.org/plugins/wp-ecards-invites/#reviews">review on Wordpress</a> :)
        </p>
    </div>
    ...
    <?php if($tab == "ecards") { ?>
        ...
        <div style="background: white; border-radius: 10px; padding: 10px; box-shadow: 0 0 10px 10px rgba(0, 0, 0, 0.115);">
            <iframe id="ecardFrame" src="https://wp.ecardwidget.com/<?php echo $iframeRoute ?>?wpAuthPing&v=1.3.5" border="0" width="100%" style="overflow:scroll;" scrolling="yes"></iframe>
        </div>
